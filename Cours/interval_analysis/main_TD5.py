...
from TD5.display_functions import *
from TD5.work2do import sivia2d, inclusion_test
import TD5.global_variables as gv
...
def btn_test_event(event):
    print("SIVIA")
    sivia2d(gv.DOMAIN, 0.2, gv.RED, gv.BLUE, gv.YELLOW, inclusion_test)
    draw()
    return event
