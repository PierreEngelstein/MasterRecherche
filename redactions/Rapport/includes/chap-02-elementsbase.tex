...
Les notions de base à connaître en informatique quantique sont décrites dans plusieurs ouvrages de référence, notamment dans \textit{Quantum Computation and Quantum Information} par Michael Nielsen et Isaac Chuang \cite{Nielsen00} ou \textit{Quantum Computer Science: An introduction} par David Mermin \cite{Mermin07}. On présente ici un résumé des notions fondamentales à connaître pour la suite du rapport.
